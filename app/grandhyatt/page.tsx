...
import { Phone, MapPin, Home, Users, Calendar, Star, CheckCircle, Award, ArrowRight, Building, Shield, Zap } from "lucide-react"
    ...
    <>
      <StructuredData 
        data={{
          ...
          url: "https://ireo-projects.vercel.app/grandhyatt"
        }}
        type="Apartment"
      />
      ...
      <main className="min-h-screen bg-white">
            ...
            <div className="relative h-full flex items-center justify-center text-center text-white px-4">
              <div className="max-w-5xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-gray-900 bg-transparent px-8 py-4 text-lg font-semibold">
                    Schedule Site Visit
                  </Button>
                </div>
              </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Experience Luxury Living?</h2>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              ...
              <Badge className="bg-white/20 backdrop-blur-sm text-white border-white/30 px-4 py-2">Hyatt Branded</Badge>
