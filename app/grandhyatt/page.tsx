...
const projectData = {
  ...
  slug: "grandhyatt",
  heroImages: [
    "/placeholder.svg?height=600&width=1000&text=Grand+Hyatt+Exterior",
    "/placeholder.svg?height=600&width=1000&text=Grand+Hyatt+Lobby",
    "/placeholder.svg?height=600&width=1000&text=Grand+Hyatt+Amenities",
    "/placeholder.svg?height=600&width=1000&text=Grand+Hyatt+Interior",
  ],
  quickFacts: {
  ...
  description: [
    "IREO The Grand Hyatt represents the pinnacle of luxury living in Gurgaon's most prestigious location. This magnificent residential development combines contemporary architecture with world-class amenities to create an unparalleled living experience for discerning homeowners.",
    "Strategically located in Sector 58, the project offers seamless connectivity to major business districts, premium shopping destinations, and educational institutions. Each residence is meticulously designed with premium finishes, spacious layouts, and panoramic views of the city skyline.",
    "The development features state-of-the-art amenities including a luxury spa, infinity pool, fitness center, and exclusive clubhouse. With 24/7 security, concierge services, and smart home automation, residents enjoy a lifestyle that epitomizes modern luxury and convenience.",
  ],
  amenities: [
    { name: "Swimming Pool", icon: "🏊", description: "Olympic-size infinity pool" },
    { name: "Fitness Center", icon: "💪", description: "Fully equipped modern gym" },
    { name: "Clubhouse", icon: "🏛️", description: "Exclusive residents' club" },
    { name: "Spa & Wellness", icon: "🧘", description: "Luxury spa and wellness center" },
    { name: "Kids Play Area", icon: "🎮", description: "Safe and fun play zone" },
    { name: "Landscaped Gardens", icon: "🌳", description: "Beautiful green spaces" },
    { name: "24/7 Security", icon: "🛡️", description: "Round-the-clock security" },
    { name: "Concierge Service", icon: "🎩", description: "Personal concierge assistance" },
    { name: "Business Center", icon: "💼", description: "Modern business facilities" },
    { name: "Banquet Hall", icon: "🎉", description: "Elegant event spaces" },
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Experience luxury living with our comprehensive range of premium amenities designed for your comfort and
              convenience.
            </p>
            <div className="w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto"></div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Take a virtual tour through our beautifully designed spaces and premium amenities.
            </p>
            <div className="w-32 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto"></div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Make This Your Home?</h2>
          <p className="text-xl mb-8 text-gray-300 max-w-3xl mx-auto">
            Don't miss this opportunity to own a piece of luxury in Gurgaon's most prestigious location.
          </p>
