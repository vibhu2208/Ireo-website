...
const properties = [
  {
    ...
    image: "/placeholder.svg?height=250&width=350&text=Grand+Arch",
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <a href={`/projects/${property.id === 1 ? "grand-arch" : "project-" + property.id}`}>
